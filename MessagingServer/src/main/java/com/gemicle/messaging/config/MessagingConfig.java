...
import com.gemicle.common.json.ObjectIdDeserializer;
import com.gemicle.common.json.ObjectIdSerializer;
...
public class MessagingConfig extends WebMvcConfigurerAdapter{
	...
	private static ApiInfo apiInfo() {
		return new ApiInfo("Logging", "", "0.1", "", new Contact("admin", "gemicle.com", "admin@gemicle.com"), "", "",new ArrayList());
	}
