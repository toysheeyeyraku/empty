...
import com.gemicle.kovtun.eventing.config.EventingProducerAutoConfigure;
import com.gemicle.kovtun.eventing.config.EventingProducerConfiguration;

@Target(ElementType.TYPE)
@Retention(RetentionPolicy.RUNTIME)
@Documented
@Import(EventingProducerAutoConfigure.class)
public @interface EnableEventingProducerAutoConfigure{
	/**
